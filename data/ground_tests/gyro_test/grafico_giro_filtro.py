# -*- coding: utf-8 -*-
"""
Created on Sat Sep  7 13:44:24 2024

@author: luisw

Gráfica prueba con giro + filtrado

filtro tipo h_dir=+-120, v_dir=+-15
"""
...
ax.plot(data[data['valid_wind']].time,data[data['valid_wind']].WIND_true_magnitude,label='calculado + filtro')
...
ax.legend()
ax.set_title(r'Comparación de viento calculado con viento medido - con filtro')

fig.set_size_inches(w=5, h=4)

fig.savefig('wind_gyro_test_filtered.pdf')
