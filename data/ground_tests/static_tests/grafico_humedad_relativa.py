...
ax.plot(manual.t_delta,manual.humidity, ':o', color='0', label='Barotermohigrómetro')
ax.plot(smak.t_delta,smak['RH'],color='0', label='SMAK-3')
...
ax.legend()
ax.set_title(r'Prueba estática - Comparación de humedad relativa')

fig.set_size_inches(w=5, h=4)

fig.savefig('prueba_estatica_humedad.pdf')