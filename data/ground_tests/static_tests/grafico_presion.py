...
Gráfico de presión en prueba estática
"""
...
ax.plot(manual.t_delta,manual.pressure, ':o', color='0', label='Barotermohigrómetro')
ax.plot(smak.t_delta,smak.P,color='0', label='SMAK-3')

#ax.set_xlim([0,60])
ax.set_ylim([995,1005])

ax.set_ylabel(r'Presión [hPa]')
ax.set_xlabel(r'Tiempo [min]')
ax.legend()
ax.set_title(r'Prueba estática - Comparación de presión')

fig.set_size_inches(w=5, h=4)

fig.savefig('prueba_estatica_presion.pdf')